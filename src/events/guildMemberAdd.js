...
Sunucumuz şuanda taglı alımdadır tagımız '✭'

Yetkili olmak için YETKİLİ ALIM DM rolündeki arkadaşlarımıza ulaşarak yetkili olabilirsin.
...
Seninle beraber ${client.numEmoji(member.guild.memberCount)} kişiyiz. :tada::tada:
    `);
  }
